...
- Release-mode ONNX baseline captured on local corpus (`.semanticfs/bench/onnx_tuning.json`) and locked into `config/onnx-test.toml` (`batch_size=32`, `SEMANTICFS_ONNX_MAX_LENGTH=128`, CPU provider).
